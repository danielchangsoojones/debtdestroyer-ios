...
class CorrectAnswerAnimationViewController: UIViewController {
    ...
    override func loadView() {
        ...
        self.nextButton.addTarget(self,
                                       ...
                                       for: .touchUpInside)
        self.earnedLabel.text = "Correct Answer!"
        self.imgView.image = UIImage.init(named: "checkmark")
